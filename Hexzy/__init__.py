...
if ENV := bool(os.environ.get("ENV", False)):
    ...
    from Hexzy.config import Development as Config
...
pbot = Client("Hexzy", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
from Hexzy.modules.helper_funcs.handlers import (
